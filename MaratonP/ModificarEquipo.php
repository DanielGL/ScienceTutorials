<!DOCTYPE html>
<?php
/*Este archivo recibe del usuario los datos para modificar un equipo, 
* despues envia los datos a servidorEquipoModificar.php
...
<form action="ModificarIntegrantes.php">
<table class="CSS_Table_Example" align="center" width="69%" border="">
    ...
    <td align="right"><input type="submit" value="Modificar" class="buttonsDesign"></td>
</tr>
