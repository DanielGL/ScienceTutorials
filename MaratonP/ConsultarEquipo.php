<!DOCTYPE html>
<?php
/*Este archivo muestra los integrantes de cada equipo
...
xmlhttp.open("GET","ObtieneEquipos.php?q="+clave+"&p=" + str+"&modo=2",true);
xmlhttp.send();
}

<!-- Funcion AJAX que obtiene los integranres del grupo especific0-->
function ObtieneMiembros(str)
{
	equipo=str;
if (str=="")
  {
...
xmlhttp.open("GET","ObtieneMiembros.php?q="+clave+"&p=" + grupo+"&equipo=" + equipo+"&modo=1",true);
xmlhttp.send();
}
</script>
</head>
