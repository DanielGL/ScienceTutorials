...
<?php 
/*Este archivo recibe del usuario los datos para modificar una materia, 
* despues envia los datos a servidorMateriaModificar.php
...
<script>
<!-- Funcion AJAX que obtiene los datos registrados actualmente para la materia-->
...
xmlhttp.open("GET","ObtieneDatos.php?clave="+str+"&modo=2",true);
xmlhttp.send();
}
</script>
...
<table class="CSS_Table_Example" align="center" width="69%" border="">
    ...
    <tr><td>Materia: </td>
      <td><select name="Clave" id="Clave" class="req" onchange="ObtieneDatos(this.value)">
