...
if ($dificultad == 1) {
    ...
    echo "<input type='button' value='Responder' name='responder' onclick='checa_robo(1)'/>";
    $frase = "Conceptos básicos";
} else if ($dificultad == 2) {

    echo "<input type='button' value='Responder' name='responder' onclick='checa_robo(2)'/>";
    $frase = "Seguimiento de código básico";
} else {

    echo "<input type='button' value='Responder' name='responder' onclick='checa_robo(3)'/>";
...
echo "<td class='responde'> Robo del equipo: " . $nombre . "</td>";
echo "</td>";
echo "</tr>";
echo "</table>";
