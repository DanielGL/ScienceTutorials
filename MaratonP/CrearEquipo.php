<!DOCTYPE html>
<?php
/*Este archivo recibe del usuario la cantidad de equipos a crear
* 
...
<table class="CSS_Table_Example" align="center" width="69%" border="">
	...
	?>
     ...
     <tr><td>Grupo: </td>
      ...
      <tr><td>Cantidad: </td>
      <td><select name="Cantidad" id="Cantidad" class="req">
	<option selected>--</option>
    ...
    <td align="right"><input type="submit" value="Crear" class="buttonsDesign"></td>
</tr>
