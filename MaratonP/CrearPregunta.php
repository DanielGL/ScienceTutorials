<!DOCTYPE html>
<?php 
/*Este archivo recibe del usuario los datos para crear una pregunta, despues envia los datos a servidorPregunta.php
...
<!-- Funcion AJAX que meustra el campo para subir imagenes-->
